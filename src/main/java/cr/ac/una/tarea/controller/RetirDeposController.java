...
public class RetirDeposController extends Controller implements Initializable {
    ...
    public int SumarTodo(){
        return SpinnerCinco.getValue() * 5 + SpinnerDiez.getValue() * 10 + SpinnerVeintiCinco.getValue() * 25 +
                SpinnerCincuenta.getValue() * 50 +  SpinnerCien.getValue() * 100 + SpinnerQuinientos.getValue() * 500 +
                SpinnerMil.getValue() * 1000 + SpinnerDosMil.getValue() * 2000 +  SpinnerCincoMil.getValue() * 5000 +
    ...
    public void initialize(URL location, ResourceBundle resources) {
        // Limites de escogencia + Set valor inicial del spinner -> min, max, initialValue
